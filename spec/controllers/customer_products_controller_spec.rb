...
describe CustomerProductsController do
    ...
    describe "search" do
        ...
        it 'should find all categories of the search result' do
            ...
            assigns[:search_results].manufacturers.should eq(manufacturers)

            assigns[:search_results].prod_categories.should eq(categories)
